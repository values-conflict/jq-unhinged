// gzip-gen-fcomment: generates a base64-encoded gzip with an FCOMMENT header field
// usage: go run gzip-gen-fcomment.go [content [comment]]
// content defaults to "Hello, world!", comment defaults to "test"
package main
...
func main() {
	...
	out = append(out, 0x00) // null terminator
